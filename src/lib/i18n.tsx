...
export const INDIC_LANGUAGES: IndicLanguage[] = [
  ...
  { code: "te", nameNative: "తెలుగు", nameEn: "Telugu", script: "Telugu", scriptRange: [0x0c00, 0x0c7f], mixedLabel: "మిశ్రమం", ready: false },
  ...
  { code: "ml", nameNative: "മലയാളം", nameEn: "Malayalam", script: "Malayalam", scriptRange: [0x0d00, 0x0d7f], mixedLabel: "മിശ്രം", ready: false },
