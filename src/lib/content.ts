...
export const IDENTITY = {
  ...
  full: L(
    ...
    {
      ta: "தமிழ், இந்தி, வங்காளம், தெலுங்கு உட்பட 22+ இந்திய மொழிகளில் எதைப் பற்றி வேண்டுமானாலும் கேளுங்கள். ஒரு நண்பர் பதில் சொல்வதைப் போல — உங்கள் சொற்களில், உங்கள் சூழலில் — பதில் கிடைக்கும். இந்தியாவில் உருவானது; இந்திய மக்களுக்கே சொந்தமானது.",
    ...
    {
      ta: "English-ல ஆரம்பியுங்க, தமிழ்ல முடியுங்க — நடுவுல மொழி மாறினாலும் இது புரிஞ்சிக்கும். இது code-switch பண்ணுற AI, நம்மள மாதிரியே.",
  ...
  footer: L(
    ...
    },
    {
      ...
      ml: "Made with care — നമ്മുടെ ഭാഷകളിൽ, നമുക്കായി.",
...
export const HERO = {
  eyebrow: L(
    ...
    {
      ta: "Kurinji · மலை — every journey ஒரு வணக்கத்துல தொடங்கும்",
  ...
  scrollCue: L(
    "come, scroll with us",
    { ta: "வாங்க, கீழே போகலாம்", hi: "आइए, नीचे चलें", ml: "വാങ്ക, താഴോട്ട് പോകാം", te: "రండి, కిందికి వెళ్దాం" },
    { ta: "வாங்க — scroll பண்ணலாம்", hi: "आइए — scroll करते हैं", ml: "വാങ്ക — scroll പണ്ണാം", te: "రండి — scroll చేద్దాం" }
  ),
};
...
export const ADHAN = {
  ...
  eyebrow: L(
    "Mullai · the forest — good things grow slowly",
    {
      ...
      te: "ముల్లై · అడవి — మంచి విషయాలు నెమ్మదిగా పెరుగుతాయి",
    },
    {
      ta: "Mullai · காடு — good things நிதானமா வளரும்",
      hi: "Mullai · जंगल — good things धीरे-धीरे बढ़ती हैं",
      ml: "Mullai · കാട് — good things സാവധാനത്തിൽ വളരും",
      te: "Mullai · అడవి — good things నెమ్మదిగా పెరుగుతాయి",
    }
  ),
  sub: L(
    "One model that grew up speaking 22+ languages",
    {
      ...
      te: "22+ భాషలు మాట్లాడుతూ పెరిగిన ఒకే మోడల్",
    },
    {
      ...
      te: "ఒకే model — కానీ 22+ భాషలు మాట్లాడుతూ పెరిగింది",
    }
  ),
  body: L(
    ...
    {
      ta: "அதன் — 700 கோடி அளவுருக்கள் கொண்ட எங்கள் மாதிரி. இந்திய மொழிகளை இது பிறகு கற்றுக்கொள்ளவில்லை; அவற்றிலேயே வளர்ந்தது. தமிழில் ஒரு கேள்வி கேளுங்கள், இந்தியில் தொடருங்கள்; தெலுங்கில் ஒரு பழமொழி சொல்லி, அதன் பொருளை வங்காளத்தில் கேளுங்கள். நடுவில் மொழிபெயர்ப்பு அடுக்கு எதுவும் கிடையாது — நம் மொழிகளிலேயே சிந்திக்கும் ஒரே மாதிரி. முழுவதுமாகத் திறந்தது: எடைகளைப் பதிவிறக்குங்கள், உங்கள் கணினியிலேயே இயக்குங்கள், உங்கள் சமூகத்திற்கென்றே செம்மைப்படுத்துங்கள்.",
...
export const SANGAM = {
  ...
  sub: L(
    "Two thousand years of Tamil poetry, one curious companion",
    {
      ...
      te: "రెండు వేల సంవత్సరాల తమిళ కవిత్వం, ఒక ఆసక్తికరమైన సహచారి",
    },
    {
...
export const GUARDIAN = {
  ...
  eyebrow: L(
    ...
    {
      ta: "யாழ் — உங்கள் குழந்தைக்கான இருமொழித் தோழன், தமிழும் ஆங்கிலமும் சேர்ந்தே வளரும்",
      ...
      te: "మీ పిల్లలకు ద్విభాషిక సహచారి — తమిళం మరియు ఇంగ్లీష్, కలిసి పెరుగుతూ",
    },
    {
      ta: "யாழ் — உங்க குழந்தைக்கான bilingual தோழன், தமிழும் English-உம் சேர்ந்து வளரும்",
      ...
      te: "మీ పిల్లలకు companion — తమిళం మరియు English, కలిసి పెరుగుతారు",
    }
  ),
  sub: L(
    "A learning pet that speaks your language and remembers your child's name",
    {
      ta: "உங்கள் மொழியில் பேசி, உங்கள் குழந்தையின் பெயரை நினைவில் வைக்கும் ஒரு கற்றல் தோழன்",
      hi: "एक सीखने वाला साथी जो आपकी भाषा बोलता है और आपके बच्चे का नाम याद रखता है",
      ml: "നിങ്ങളുടെ ഭാഷ സംസാരിക്കുന്ന, നിങ്ങളുടെ കുട്ടിയുടെ പേര് ഓർത്തുവയ്ക്കുന്ന ഒരു പഠന സഹചാരി",
      te: "మీ భాష మాట్లాడే, మీ పిల్లల పేరు గుర్తుంచుకునే ఒక అభ్యాస సాథి",
    },
    {
      ta: "Learning pet — நம்ம மொழியில் பேசும், உங்க குழந்தை மாதிரியே",
      ...
      te: "Learning pet — మన భాషలలో మాట్లాడుతుంది, మీ పిల్లల్లాగే",
    }
  ),
  body: L(
    ...
    {
      ta: "யாழ் என்பது 4 முதல் 12 வயது வரையிலான குழந்தைகளுக்கான இருமொழித் தோழன் — தமிழையும் ஆங்கிலத்தையும் நிஜ குடும்பங்கள் பேசுவதைப் போலவே ஒரே வாக்கியத்தில் கலந்து பேசும். உங்கள் குழந்தையின் பெயரையும் பிடித்த கதைகளையும் நினைவில் வைத்திருக்கும். பழம்பெரும் கோயில் தூண்களில் காணப்படும் யாளியிலிருந்து பிறந்த பெயர் இது; இன்று மொழியை உயிரோட்டமாக வைத்திருக்கும் பணியில் ஈடுபட்டுள்ளது — கேள்விகளுக்குப் பதிலளித்தும், விளையாட்டு விளையாடியும், தமிழ்நாடு, யாழ்ப்பாணம், சிங்கப்பூர், டொரன்டோ என உலகெங்கும் உள்ள பாட்டிமார்களிடமிருந்து சேகரிக்கப்பட்ட படுக்கை நேரக் கதைகளைச் சொல்லியும். ஒவ்வொரு கதையும் அதைப் பகிர்ந்த பெரியவரின் பெயருடனேயே நினைவுகூரப்படும். யாழ் உங்கள் குழந்தையுடன் சேர்ந்தே வளரும்; ஒருபோதும் தண்டிக்காது — ஒவ்வொரு முயற்சியும் ஒரு கற்றல் தருணமே.",
      ...
      te: "యాఴ్ 4 నుండి 12 సంవత్సరాల పిల్లలకు ఒక ద్విభాషా సహచరుడు — తమిళం మరియు ఇంగ్లీష్ నిజమైన కుటుంబాలు మాట్లాడే విధంగానే ఒకే వాక్యంలో కలిపి మాట్లాడతాడు. మీ పిల్లల పేరునీ, ఇష్టమైన కథలనూ గుర్తుంచుకుంటాడు. పురాతన ఆలయ స్తంభాలపై కనిపించే యాఴి నుండి పుట్టిన పేరు ఇది; ఇవాళ భాషను సజీవంగా ఉంచే పనిలో నిమగ్నమై ఉన్నాడు — ప్రశ్నలకు సమాధానమిస్తూ, ఆటలాడుతూ, తమిళనాడు, యాఴ్‌ప్పాణం, సింగపూర్, టొరంటోలలోని అమ్మమ్మల నుండి సేకరించిన నిద్రవేళ కథలు చెబుతూ. ప్రతి కథ దానిని పంచుకున్న పెద్దల పేరుతోనే గుర్తుండిపోతుంది. యాఴ్ మీ పిల్లలతో పాటే పెరుగుతాడు; ఎప్పుడూ తప్పు పట్టడు — ప్రతి ప్రయత్నం ఒక నేర్చుకునే క్షణమే.",
    },
    {
      ta: "4-12 வயது குழந்தைகளுக்கான companion — தமிழிலும் ஆங்கிலத்திலும் பேசும். குழந்தையோட பேரு ஞாபகம் வெச்சிருக்கும், questions-க்கு பதில் சொல்லும், games விளையாடும், bedtime stories சொல்லும் — அவை பாட்டிமார்களிடமிருந்து சேகரிச்ச கதைகள். குழந்தையோடயே வளரும், ஒருபோதும் judge பண்ணாது — ஒவ்வொரு try-க்கும் கத்துக்க ஒரு chance கொடுக்கும்.",
      ...
      ml: "4-12 വയസ്സുള്ള കുട്ടികൾക്കായി companion — തമിഴിലും ഇംഗ്ലീഷിലും സംസാരിക്കുന്നു. കുട്ടിയുടെ പേര് ഓർത്തുവയ്ക്കുന്നു, questions-നു ഉത്തരം നൽകുന്നു, games കളിക്കുന്നു, bedtime stories പറയുന്നു — അവ അമ്മൂമ്മമാരിൽ നിന്ന് ശേഖരിച്ച കഥകളാണ്. കുട്ടിയോടൊപ്പം വളരുന്നു, ഒരിക്കലും judge ചെയ്യുന്നില്ല — ഓരോ ശ്രമത്തിനും പഠിക്കാനുള്ള അവസരം നൽകുന്നു.",
      te: "4-12 ఏళ్ల పిల్లలకు companion — తమిళంలోనూ ఇంగ్లీష్‌లోనూ మాట్లాడుతుంది. పిల్లల పేరు గుర్తుంచుకుంటుంది, ప్రశ్నలకు సమాధానం ఇస్తుంది, games ఆడుతుంది, bedtime stories చెబుతుంది — అవి అమ్మమ్మల నుండి సేకరించిన కథలు. పిల్లలతో పాటే పెరుగుతుంది, ఎప్పుడూ judge చేయదు — ప్రతి ప్రయత్నానికీ నేర్చుకునే అవకాశం ఇస్తుంది.",
    }
  ),
  cta: L(
    "Start your child's journey",
    {
      ta: "யாழுடன் உங்கள் குழந்தையின் பயணத்தைத் தொடங்குங்கள்",
      hi: "अपने बच्चे की यात्रा शुरू करें",
      ml: "നിങ്ങളുടെ കുട്ടിയുടെ യാത്ര ആരംഭിക്കുക",
      te: "మీ పిల్లల ప్రయాణాన్ని ప్రారంభించండి",
    },
    {
      ta: "யாழோட குழந்தையோட journey தொடங்கலாம்",
      hi: "बच्चे की journey शुरू करते हैं",
      ml: "കുട്ടിയുടെ journey തുടങ്ങാം",
      te: "పిల్లల journey మొదలుపెడదాం",
    }
  ),
  ctaHref: "/onboarding",
  /** Secondary CTA — Yazh's daily stories reach diaspora families over
      WhatsApp first; the group is where founding families actually are. */
  whatsappCta: L(
    "Join our WhatsApp group for daily Tamil stories",
    {
      ta: "தினசரி தமிழ்க் கதைகளுக்கு எங்கள் WhatsApp குழுவில் இணையுங்கள்",
      hi: "रोज़ाना तमिल कहानियों के लिए हमारे WhatsApp ग्रुप से जुड़िए",
      ml: "ദിവസവുമുള്ള തമിഴ് കഥകൾക്കായി ഞങ്ങളുടെ WhatsApp ഗ്രൂപ്പിൽ ചേരുക",
      te: "ప్రతిరోజు తమిళ్ కథల కోసం మా WhatsApp గ్రూప్‌లో చేరండి",
    },
    {
      ta: "Daily தமிழ்க் கதைகளுக்கு WhatsApp குழுவில ஜாயின் பண்ணுங்க",
      hi: "Daily तमिल कहानियों के लिए WhatsApp group में join कीजिए",
      ml: "Daily തമിഴ് കഥകൾക്കായി WhatsApp ഗ്രൂപ്പിൽ ചേരൂ",
      te: "Daily తమిళ్ కథల కోసం WhatsApp గ్రూప్‌లో join అవ్వండి",
    }
  ),
  whatsappHref: "https://chat.whatsapp.com/G0sWRof4Z4cFXXY6Gmavmu",
};
...
export const COMMUNITY = {
  ...
  eyebrow: L(
    "Neytal · the seashore — the sea took us far; the net brings us home",
    {
      ...
      te: "నెయ్తల్ · సముద్ర తీరం — సముద్రం మనల్ని దూరం తీసుకెళ్ళింది; నెట్‌వర్క్ ఇంటికి తీసుకువస్తుంది",
    },
    {
  ...
  cards: [
    {
      title: L(
        "WhatsApp group",
        { ta: "WhatsApp குழு", hi: "WhatsApp समूह", ml: "WhatsApp ഗ്രൂപ്പ്", te: "WhatsApp గ్రూప్" }
      ),
      body: L(
        "Daily Tamil stories, language tips, and updates on Yazh — straight to your phone. No app to install, no account to make; just tap and join.",
        {
          ta: "தினசரி தமிழ்க் கதைகள், மொழி குறிப்புகள், யாழ் பற்றிய புதுப்பிப்புகள் — நேரடியாக உங்கள் ஃபோனுக்கு. வேறு எந்த app-உம் தேவையில்லை, கணக்கும் தேவையில்லை; தட்டி இணைந்துவிடுங்கள்.",
          hi: "रोज़ाना तमिल कहानियाँ, भाषा से जुड़े सुझाव, और Yazh के अपडेट — सीधे आपके फ़ोन पर। कोई ऐप इंस्टॉल नहीं, कोई अकाउंट नहीं; बस टैप कीजिए और जुड़ जाइए।",
          ml: "ദിവസവും തമിഴ് കഥകൾ, ഭാഷാ നുറുങ്ങുകൾ, Yazh അപ്ഡേറ്റുകൾ — നേരിട്ട് നിങ്ങളുടെ ഫോണിലേക്ക്. ആപ്പ് ഇൻസ്റ്റാൾ വേണ്ട, അക്കൗണ്ട് വേണ്ട; ടാപ്പ് ചെയ്ത് ചേരുക.",
          te: "ప్రతిరోజు తమిళ్ కథలు, భాషా చిట్కాలు, Yazh అప్‌డేట్‌లు — నేరుగా మీ ఫోన్‌కి. యాప్ ఇన్‌స్టాల్ అవసరం లేదు, ఖాతా అవసరం లేదు; టాప్ చేసి చేరండి.",
        },
        {
          ta: "Daily-ஆ தமிழ்க் கதைகள், language tips, யாழ் updates — உங்க phone-க்கே நேரடியா. App வேணாம், account வேணாம்; tap பண்ணி join ஆகிடுங்க.",
          hi: "Daily तमिल कहानियाँ, language tips, Yazh updates — सीधे आपके phone पर। App नहीं चाहिए, account नहीं चाहिए; tap कीजिए और join हो जाइए।",
        }
      ),
      href: "https://chat.whatsapp.com/G0sWRof4Z4cFXXY6Gmavmu",
...
export const SERVICES: { label: LText }[] = [
  ...
  { label: L("Annotations", { ta: "விளக்கங்கள்", hi: "एनोटेशन", ml: "അനോടേഷനുകൾ", te: "వ్యాఖ్యానాలు" }) },
];
...
export const NAV_GROUPS: { label: LText; items: { label: LText; href: string }[] }[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { label: L("Annotations", { ta: "விளக்கங்கள்", hi: "एनोटेशन", ml: "അനോടേഷനുകൾ", te: "వ్యాఖ్యానాలు" }), href: "#services" },
    ],
  },
  {
...
export const UI = {
  ...
  poeticCol: L("What it stands for", { ta: "உரிப்பொருள்", hi: "भाव", ml: "അതു പ്രതിനിധാനം ചെയ്യുന്നത്", te: "ఇది సూచించేది" }),
  awakening: L(
    "Yazhi awakens in…",
